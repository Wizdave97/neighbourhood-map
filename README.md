...
Clone the repository to your local machine and run `npm install` to install dependencies
Run `yarn start` to start the local server, the server runs on port 3000
